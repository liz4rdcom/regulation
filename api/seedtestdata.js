...
const testLibs = [
  {
    ...
    legalForms: [
      { name: 'არასამეწარმეო (არაკომერციული) იურიდიული პირი', abbrev: 'ა(ა)იპ' },
      { name: 'ინდივიდუალური მეწარმე' },
      { name: 'კომანდიტური საზოგადოება', abbrev: 'კს' },
      { name: 'კოოპერატივი' },
      { name: 'კავშირი' },
      { name: 'სახელმწიფო' },
      { name: 'საჯარო სამართლის იურიდიული პირი', abbrev: 'სსიპ' },
      { name: 'სააქციო საზოგადოება', abbrev: 'სს, კორპორაცია' },
      { name: 'სოლიდარული პასუხისმგებლობის საზოგადოება', abbrev: 'სპს' },
      { name: 'ფონდი' },
      { name: 'ფიზიკური პირი' },
      { name: 'შეზღუდული პასუხისმგებლობის საზოგადოება', abbrev: 'შპს' }
    ],
    commandTypes: [
      'ცვლილება',
      'გაცემა',
