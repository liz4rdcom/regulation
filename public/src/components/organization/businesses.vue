    ...
    >
      ...
      <b-modal ref="businessChangeModal" title="საქმიანობა" ok-title="შენახვა" cancel-title="გაუქმება" @ok="onSave" @cancel="onCancel">
        ...
        <b-row class="mb-1" >
          ...
          <b-col>
            <b-form-select v-model="currentBusiness.regulationId" @change="onRegulationChange" class="mb-1 col-md-12">
        ...
        <b-row >
          ...
          <b-col>
            <b-form-select v-model="currentBusiness.businessType" class="mb-1 col-md-12">
