            ...
            <b-row>
              <b-col>
                ...
                <b-form-group label="Napr სტატუსი">
                  <b-form-select id="orgs-add-napr-status-select" v-model="organization.naprStatus" class="mb-3">
              ...
              <b-col>
                ...
                <b-form-group label="E-Health Email">
                  <b-form-input id="orgs-add-ehealth-email" type="text" v-model="organization.ehealthEmail"></b-form-input>
                </b-form-group>
              </b-col>
            </b-row>
          </b-container>
