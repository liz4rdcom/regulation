        ...
        <b-container>
          <b-row>
            <b-col>
              ...
              >
                <locations :locations="locations" inputClass="col-md-12" @change="onJuridicalAddressChanged"></locations>
              </b-card>
            </b-col>
            <b-col>
              <b-card
                ...
                header-text-variant="white"
              >
                <locations :locations="locations" inputClass="col-md-12" @change="onFactualAddressChanged"></locations>
              </b-card>
            </b-col>
          </b-row>
        </b-container>
