            ...
            <b-col>
              <div class="rowDirection">
                <b-form-group label="პირადი ნომერი" class="col-md-10" style="padding:0 5px 0 0; margin:0;">
                  <b-form-input :id="idWithPrefix(idPrefix, 'managers-change-modal-personal-id')" v-model="currentManager.personalId" type="text" @keyup.enter.native="callSync()"></b-form-input>
                </b-form-group>
              ...
              <b-form-group label="სახელი" >
                <b-form-input :id="idWithPrefix(idPrefix, 'managers-change-modal-firstname')" v-model="currentManager.firstName" type="text"></b-form-input>
              </b-form-group>
              <b-form-group label="გვარი" >
                <b-form-input :id="idWithPrefix(idPrefix, 'managers-change-modal-lastname')" v-model="currentManager.lastName" type="text"></b-form-input>
              </b-form-group>
            </b-col>
          </b-row>
